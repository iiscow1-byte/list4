        ...
        <header class="relative overflow-hidden rounded-xl border border-zinc-800 bg-zinc-950">
          ...
          <div class="relative p-4 flex items-start justify-between gap-3">
            ...
            <button
              v-if="!editing"
              type="button"
              class="btn btn-sm btn-ghost shrink-0 bg-zinc-950/70 hover:border-accent hover:text-accent"
              @click="startEdit"
            >Edit</button>
          </div>
        </header>
        ...
        >
          ...
          <div class="grid grid-cols-1 sm:grid-cols-3 gap-3">
            ...
            <label class="block text-xs">
              ...
              <input v-model="editDraft.rated" type="text" placeholder="Rated / Featured / Epic / Legendary / Mythic / Challenge" class="field field-sm mt-1" />
            </label>
          </div>
          <div class="grid grid-cols-1 sm:grid-cols-3 gap-3">
            <label class="block text-xs">
