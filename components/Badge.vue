...
import { BADGE_BASE, BADGE_SIZE, BADGE_TONE, hexBadgeStyle, type BadgeSize, type BadgeTone } from '~/utils/badge-styles'
...
withDefaults(defineProps<{
  ...
  color?: string | null
  title?: string | null
}>(), { tone: 'neutral', size: 'md', color: null, title: null })
</script>

<template>
  <span
    :class="[BADGE_BASE, BADGE_SIZE[size], hexBadgeStyle(color) ? '' : BADGE_TONE[tone]]"
    :style="hexBadgeStyle(color)"
