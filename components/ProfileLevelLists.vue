...
<template>
  <section v-if="completed?.length" class="rounded-xl border border-zinc-800 bg-zinc-950/60">
  ...
  <section v-if="verified?.length" class="rounded-xl border border-zinc-800 bg-zinc-950/60 mt-4">
    <h2 class="text-xs uppercase tracking-widest text-zinc-500 font-medium px-4 pt-3 pb-2 flex items-baseline gap-2">
      Levels Verified
  ...
  <section v-if="created?.length" class="rounded-xl border border-zinc-800 bg-zinc-950/60 mt-4">
    <h2 class="text-xs uppercase tracking-widest text-zinc-500 font-medium px-4 pt-3 pb-2 flex items-baseline gap-2">
      Levels Created
